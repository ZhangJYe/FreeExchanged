...
func (c *favoriteClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PingResp)
	err := c.cc.Invoke(ctx, Favorite_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFavoriteServer) Ping(context.Context, *PingReq) (*PingResp, error) {
...
func RegisterFavoriteServer(s grpc.ServiceRegistrar, srv FavoriteServer) {
	// If the following call panics, it indicates UnimplementedFavoriteServer was
...
func _Favorite_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoriteServer).Ping(ctx, req.(*PingReq))
	}
