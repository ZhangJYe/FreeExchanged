...
const (
	...
	Article_ListArticles_FullMethodName = "/article.Article/ListArticles"
)
...
func (c *articleClient) Publish(ctx context.Context, in *PublishReq, opts ...grpc.CallOption) (*PublishResp, error) {
...
func (c *articleClient) ListArticles(ctx context.Context, in *ListArticlesReq, opts ...grpc.CallOption) (*ListArticlesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListArticlesResp)
	err := c.cc.Invoke(ctx, Article_ListArticles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedArticleServer) Publish(context.Context, *PublishReq) (*PublishResp, error) {
...
func (UnimplementedArticleServer) ListArticles(context.Context, *ListArticlesReq) (*ListArticlesResp, error) {
...
func _Article_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).Publish(ctx, req.(*PublishReq))
	}
...
func _Article_ListArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).ListArticles(ctx, req.(*ListArticlesReq))
	}
	return interceptor(ctx, in, info, handler)
}
