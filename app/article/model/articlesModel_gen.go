...
func (m *defaultArticlesModel) Insert(ctx context.Context, data *Articles) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Title, data.Content, data.AuthorId, data.Status, data.LikeCount, data.ViewCount)
	return ret, err
}
...
func (m *defaultArticlesModel) Update(ctx context.Context, data *Articles) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Title, data.Content, data.AuthorId, data.Status, data.LikeCount, data.ViewCount, data.Id)
	return err
}
